...
public interface FoodRepository extends JpaRepository<Food, Long> {
    ...
    Page<FoodMapping> findDistinctAllBySoupAndBasicsIdInAndCooksIdInAndIngredientsIdInAndStatesIdIn
            (Pageable pageable, String soup, List<Integer> basic, List<Integer> cook, List<Integer> ingredient, List<Integer> state);
}
